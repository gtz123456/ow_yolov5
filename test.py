...
from mouse_control import lock1, lock2, lock3, lock4

# ---------------------------设置参数------------------------
weights = r'E:\ow_yolov5_old\yolov5-master\CF_AI\cfbest.pt'  # 模型存放的位置
window_size = (0, 0, 800, 600)  # 需要截屏的位置
re_x, re_y = 800, 600  # 1.cv2窗口大小 2.锁人范围大小
