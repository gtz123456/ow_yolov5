...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='mydata\mydata_1.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'mydata\mydata.yaml', help='dataset.yaml path')
